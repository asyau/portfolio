    ...
    return (
        <div className="mx-auto w-full max-w-screen-2xl px-6 md:px-12 lg:px-24 py-16 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-4">
                    {experiences.map((exp, i) => (
                        <FadeIn key={i} delay={i * 0.08}>
                            <MotionCard className="group p-6 rounded-xl border border-border/50 hover:border-border hover:bg-secondary/30 transition-colors duration-300">
                                ...
                                {exp.github && (
                                    <Link
                                        href={exp.github}
                                        target="_blank"
                                        className="inline-block mt-4 text-sm text-accent-brand hover:opacity-75 transition-opacity font-medium"
                                    >
                                        View on GitHub →
                                    </Link>
                                )}
                ...
                {/* Leadership Section */}
                <FadeIn delay={0.1} className="mt-16 pt-12 border-t border-border/40">
                    <h2 className="text-xs font-medium uppercase tracking-wider text-muted-foreground mb-6">Leadership</h2>
                    <MotionCard className="p-6 rounded-xl border border-border/50 hover:border-border transition-colors">
                        ...
                        <div className="space-y-2 mb-4">
                            <div className="flex items-center gap-3">
                                <span className="px-2.5 py-1 text-xs font-medium bg-accent-brand text-white rounded">President</span>
